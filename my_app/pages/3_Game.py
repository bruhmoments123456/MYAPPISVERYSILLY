...
tabA,tabB,tabC,tabD,tabF,tabG, tabH, tabI= st.tabs(["Game tung xúc sắc", "Game đoán số", "Kéo - Búa - Bao", "Game tính toán nhanh", "Game đuổi hình bắt chữ", "Game trắc nghiệm", "Game quay số may mắn", "Game quay số may mắn V2",])
with st.sidebar:
